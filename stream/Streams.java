...
public class Streams {
	...
	public static void main(String[] args) {
		List<List<String>> countries = Arrays.asList(Arrays.asList("0", "", "", "cuba"),
			...
			printCountOfRepeatedCharsInString();
	        
	        
	        printCountOfRepeatedWordsInString();
	        
		 
	}


	private static void printCountOfRepeatedWordsInString() {
		...
		System.out.println("Count of all words in the string '"+words+"' : " + countOfWords);
	}


	private static void printCountOfRepeatedCharsInString() {
		...
		System.out.println("1) Count of all characters in the string '"+s+"' : " + charCount);
		...
		s.chars()
        .mapToObj(c -> (char) c) // Convert int stream to char stream
		.forEach(chr -> counts.put(chr, counts.getOrDefault(chr, 0)+1));
		
		System.out.println("2) Count of all characters in the string '"+s+"' : " + counts);
